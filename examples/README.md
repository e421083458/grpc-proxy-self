...
```
$ go get -u github.com/e421083458/grpc-proxy/examples/helloworld/greeter_client
$ go get -u github.com/e421083458/grpc-proxy/examples/helloworld/greeter_server
```
...
1. Rebuild the generated Go code
   ...
   ```
   $ go generate github.com/e421083458/grpc-proxy/examples/helloworld/...
   ```
