...
```shell
$ go get github.com/e421083458/grpc-proxy
```

Then change your current directory to `grpc-go/examples/route_guide`:
```shell
$ cd $GOPATH/src/github.com/e421083458/grpc-proxy/examples/route_guide
```
...
`$GOPATH/src/github.com/e421083458/grpc-proxy/examples/route_guide`, simply:
