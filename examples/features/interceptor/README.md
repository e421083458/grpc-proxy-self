...
[`UnaryClientInterceptor`](https://godoc.org/github.com/e421083458/grpc-proxy#UnaryClientInterceptor)
...
`DialOption`
[`WithUnaryInterceptor`](https://godoc.org/github.com/e421083458/grpc-proxy#WithUnaryInterceptor).

#### Stream Interceptor

[`StreamClientInterceptor`](https://godoc.org/github.com/e421083458/grpc-proxy#StreamClientInterceptor)
...
`DialOption`
[`WithStreamInterceptor`](https://godoc.org/github.com/e421083458/grpc-proxy#WithStreamInterceptor).
...
[`UnaryServerInterceptor`](https://godoc.org/github.com/e421083458/grpc-proxy#UnaryServerInterceptor)
...
`ServerOption`
[`UnaryInterceptor`](https://godoc.org/github.com/e421083458/grpc-proxy#UnaryInterceptor).

#### Stream Interceptor

[`StreamServerInterceptor`](https://godoc.org/github.com/e421083458/grpc-proxy#StreamServerInterceptor)
...
To install the unary interceptor for a Server, configure `NewServer` with
`ServerOption`
[`StreamInterceptor`](https://godoc.org/github.com/e421083458/grpc-proxy#StreamInterceptor).
